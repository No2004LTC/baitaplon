      ...
      <form action="" method="post">
        ...
        <div class="form-group mt-3">
          ...
          <select name="Manv" id="Manv" class="form-control" required>
            ...
            <option value="<?php echo $nv['Manv']; ?>" <?php if ($nv['Manv'] == $row['Manv']) echo 'selected'; ?>>
              <?php echo $nv['Manv']; ?>
            </option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="form-group mt-3">
          ...
          <input type="text" name="Noilamviec" id="Noilamviec" class="form-control"
            value="<?php echo $row['Noilamviec']; ?>" placeholder="Nhập nơi làm việc" required />
        </div>

        <div class="form-group mt-3">
          <label for="Vitricongtac">Vị trí công tác</label>
          <input type="text" name="Vitricongtac" id="Vitricongtac" class="form-control"
            value="<?php echo $row['Vitricongtac']; ?>" placeholder="Nhập vị trí công tác" required />
        </div>

        <div class="form-group mt-3">
          <label for="Ngaybatdaulam">Ngày bắt đầu làm</label>
<input type="date" name="Ngaybatdaulam" id="Ngaybatdaulam" class="form-control"
            value="<?php echo $row['Ngaybatdaulam']; ?>" required />
        </div>

        <div class="form-group mt-3">
          <label for="Ngayketthuclam">Ngày kết thúc làm</label>
          <input type="date" name="Ngayketthuclam" id="Ngayketthuclam" class="form-control"
            value="<?php echo $row['Ngayketthuclam']; ?>" required />
        </div>

        <div class="form-group mt-3">
          <label for="Hopdonglaodong">Hợp đồng lao động</label>
          <input type="text" name="Hopdonglaodong" id="Hopdonglaodong" class="form-control"
            value="<?php echo $row['Hopdonglaodong']; ?>" placeholder="Nhập hợp đồng lao động" required />
        </div>
        ...
        <div class="form-group mt-3">
          ...
          <select name="Hocvi" id="Hocvi" class="form-control" required>
            ...
            <?php foreach ($nhanvien as $nv): ?>
            <option value="<?php echo $nv['Hocvi']; ?>" <?php if ($nv['Hocvi'] == $row['Hocvi']) echo 'selected'; ?>>
              <?php echo $nv['Hocvi']; ?>
            </option>
            <?php endforeach; ?>
          </select>
