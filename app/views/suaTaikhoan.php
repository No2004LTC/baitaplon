    ...
    <body>
        ...
        >
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name='tentk' id="tentk" class="form-control" value="<?php echo $table[0]['tentk'] ?>" required>
                </div>
                <div class="form-group mt-3">
                    <label for="matkhau">Mật khẩu</label>
                    <input type="text" name='matkhau' id="matkhau" class="form-control" value="<?php echo $table[0]['matkhau'] ?>" required>
                </div>
