      ...
      <div class="content">
        <div class="table-data">
          <div class="function">
            ...
            <button type="button" class="btn btn-success" style="margin-top:20px" ><a href="<?=_WEB_HOST?>/Taikhoan/add">Thêm</a></button>
          </div>
                ...
                ?>
                  <tr>
                    ...
                    <td style="margin: 0 auto; text-align: center">
                      <a href="<?= _WEB_HOST ?>/Taikhoan/edit_lop/<?= $row['Manv'] ?>" class="btn btn-warning">Sửa</a>
                      <a href="<?= _WEB_HOST ?>/Taikhoan/delete_lop/<?= $row['Manv'] ?>" class="btn btn-danger" onclick="return comfim('Xác nhận xóa!')">Xóa</a>
                    </td>          
                  </tr>
                <?php
                  endforeach;
