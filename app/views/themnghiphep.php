    ...
    <div class="container-fluid">
      ...
      <form action="" method="post">
        ...
        <div class="form-group mt-3">
          ...
          <input type="date" name="Ngaybatdaunghi" id="Ngaybatdaunghi" class="form-control" required>
        </div>

        <div class="form-group mt-3">
          <label for="Songaynghi">Số ngày nghỉ</label>
          <input type="number" name="Songaynghi" id="Songaynghi" class="form-control" min="0" max="12" required>
        </div>
